    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Utilidades.marcadores.setLatitudInicial(Double.valueOf(txtLatInicio.getText().toString()));
                Utilidades.marcadores.setLongitudInicial(Double.valueOf(txtLongInicio.getText().toString()));
                Utilidades.marcadores.setLatitudFinal(Double.valueOf(txtLatFinal.getText().toString()));
                Utilidades.marcadores.setLongitudFinal(Double.valueOf(txtLongFinal.getText().toString()));
